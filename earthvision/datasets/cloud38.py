...
class Cloud38(VisionDataset):
    ...
    def __init__(
        ...
        self.base_path = Path(os.path.join(
            self.data_path, "38-Cloud_training"))
    ...
    def get_path(self):
        ...
        label_listing = [os.path.join(path_label, i)
    ...
    def create_rgb_pil(self, red_filename: Path):
        ...
        rgb_fn = self.red_filename.replace(
            'red', 'rgb').replace('.TIF', '.png')
    ...
    def _check_exists(self):
        ...
        """
        folders = ["38-Cloud_95-Cloud_Test_Metadata_Files", "38-Cloud_test",
                   "38-Cloud_training", "38-Cloud_Training_Metadata_Files"]

        status = [os.path.exists(os.path.join(
            self.data_path, folder_pth)) for folder_pth in folders]
        return all(status)
